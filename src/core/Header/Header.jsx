  ...
  return (
    <>
      <header className="fixed top-0 z-50 w-full bg-white border-b-2 shadow-sm md:py-3 ">
        ...
        <div className={`fixed top-0 right-0 h-full bg-white shadow-lg w-[260px] transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"} z-50`}>
          <div className="p-4">
        ...
        {isSearchActive && <div className="fixed inset-0 z-40 bg-black opacity-50" onClick={handleSearchBlur}></div>}
      </header>
    </>
  );
}
