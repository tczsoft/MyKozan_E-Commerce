export default function Dashboardcard() {
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
      <div className="relative p-5 overflow-hidden border border-b-3 border-b-green-400 rounded-xl">
        <div className="flex items-center justify-center mb-5 border rounded-full shadow size-12 bg-slate-100">
          <i className="mt-2 text-2xl text-green-600 fi fi-sr-user-tag"></i>
        </div>
        <div>
      ...
      <div className="relative p-5 overflow-hidden border border-b-3 border-b-green-400 rounded-xl">
        <div className="flex items-center justify-center mb-5 border rounded-full shadow size-12 bg-slate-100">
          <i className="mt-2 text-2xl text-green-600 fi fi-sr-inbox-in"></i>
        </div>
        <div>
      ...
      <div className="relative p-5 overflow-hidden border border-b-3 border-b-green-400 rounded-xl">
        <div className="flex items-center justify-center mb-5 border rounded-full shadow size-12 bg-slate-100">
          <i className="mt-2 text-2xl text-green-600 fi fi-ss-process"></i>
        </div>
        <div>
      ...
      <div className="relative p-5 overflow-hidden border border-b-3 border-b-green-400 rounded-xl">
        <div className="flex items-center justify-center mb-5 border rounded-full shadow size-12 bg-slate-100">
          <i className="mt-2 text-2xl text-green-600 fi fi-ss-shipping-fast"></i>
        </div>
        <div>
          <h1 className="text-xl font-semibold">30</h1>
